 ...
 * Copyright 2023 @ Jean Olivier Simoneau (modifications)
 *
...
enum layers{
  ...
  FN_RGB,   // Layer to adjust the RGB/Backlight
...
[FN_RGB] = LAYOUT_ansi_68(
     ...
     KC_TRNS,  BT_HST1,  BT_HST2,  BT_HST3,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  RGB_M_P,   KC_TRNS,   KC_TRNS,  KC_TRNS,  KC_TRNS,
...
[GUILAY] = LAYOUT_ansi_68(
     ...
     KC_TRNS,  KC_TRNS,  AC_G_W,   AC_G_E,   KC_TRNS,  AC_G_T,   KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,    KC_TRNS,  KC_TRNS,  KC_TRNS,
     KC_TRNS,  KC_TRNS,  AC_G_S,   AC_G_D,   KC_TRNS,  KC_TRNS,  AC_G_H,   KC_TRNS,  KC_TRNS,  AC_G_L,   KC_TRNS,  KC_TRNS,              KC_TRNS,  KC_TRNS,
     KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,              KC_PGUP,  KC_TRNS,
     KC_TRNS,  KC_TRNS,  KC_TRNS,                                AC_G_SPC,                     KC_TRNS,  KC_TRNS,  KC_TRNS,    KC_HOME,  KC_PGDN,  KC_END),
};
